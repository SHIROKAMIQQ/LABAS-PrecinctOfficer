import { nullable, object, picklist, number, string, type InferOutput, union, array, variant, literal } from 'valibot';
...
export const ScanBallotMessageSchema = variant('type', [ScanBallotStatusSchema, ScanBallotResultSchema]);
